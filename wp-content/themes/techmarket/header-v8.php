...
<div id="page" class="hfeed site">
	<?php
	/**
	 * Functions hooked into techmarket_before_header_v8
	 *
	 * @hooked techmarket_skip_links                       - 0
	 * @hooked techmarket_social_icons                     - 10
	 */
	do_action( 'techmarket_before_header_v8' ); ?>

	<header id="masthead" class="site-header header-v8" style="<?php techmarket_header_styles(); ?>">

		<div class="col-full <?php echo techmarket_has_handheld_header() ? 'desktop-only' : ''; ?>">

			<?php
			/**
			 * Functions hooked into techmarket_header_v8 action
			 *
			 ...
			 */
			do_action( 'techmarket_header_v8' ); ?>
