<?php
/**
 * Creates a Poster Widget which can be placed in sidebar
 *
 * @class       Techmarket_Poster_Widget
 * @version     1.0.0
 * @package     Widgets
 * @category    Class
 * @author      Transvelo
...
if( class_exists( 'WP_Widget' ) ) :
	/**
	 * Techmarket Poster Widget class
	 *
	 * @since 1.0.0
	 */
	class Techmarket_Poster_Widget extends WP_Widget {

		public function __construct() {
			$widget_ops = array( 'description' => esc_html__( 'Add poster widget to your sidebar.', 'techmarket' ) );
			parent::__construct( 'techmarket_poster_widget', esc_html__( 'Techmarket Poster', 'techmarket' ), $widget_ops );
		}
		...
		public function widget($args, $instance) {
			...
			$bg_image = isset( $instance['bg_image'] ) && intval( $instance['bg_image'] ) ? wp_get_attachment_image_src( $instance['bg_image'], 'full' ) : array( '//placehold.it/260x705', '260', '705' );
			...
			$atts = apply_filters( 'techmarket_poster_widget_args', array(
		...
		public function update( $new_instance, $old_instance ) {
			...
			if ( ! empty( $new_instance['condition'] ) ) {
		...
		public function form( $instance ) {
			...
			<div class="options_group">
				<div class="product-options">
					...
					<p>
						<label for="<?php echo esc_attr( $this->get_field_id('condition') ); ?>"><?php esc_html_e( 'Condition:', 'techmarket' ) ?></label>
						<textarea rows="1" cols="28" id="<?php echo esc_attr( $this->get_field_id('condition') ); ?>" class="widefat" name="<?php echo esc_attr( $this->get_field_name('condition') ); ?>"><?php echo wp_kses_post( $condition ); ?></textarea>
					</p>
					<p>
