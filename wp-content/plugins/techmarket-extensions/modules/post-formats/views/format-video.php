<div class="cf-elm-block" id="cfpf-format-video-fields" style="display: none;">
	<div id="postbox-container-postformat" class="postbox-container">
		<div id="meta-box-postformat-video" class="postbox" style="display: block;">
			...
			<h3><span><?php esc_html_e( 'Video Options', 'techmarket-extensions' ); ?></span></h3>			
			<div class="inside">
				<p style="padding:10px 0 0 0;"><?php esc_html_e( 'For HTML5 video support and Flash fallback please include an M4V file. Include an OGV file optionally to increase cross browser support.', 'techmarket-extensions' ); ?></p>
				<table class="form-table">
					<tbody>
						<tr>
							<th>
								<label for="postformat_video_m4v">
									<strong><?php esc_html_e( 'M4V File URL', 'techmarket-extensions' ); ?></strong>
									<span><?php esc_html_e( 'The URL to the .m4v video file', 'techmarket-extensions' ); ?></span>
								</label>
							</th>
							<td>
						...
						<tr>
							<th>
								<label for="postformat_video_ogv">
									<strong><?php esc_html_e( 'OGV File URL', 'techmarket-extensions' ); ?></strong>
									<span><?php esc_html_e( 'The URL to the .ogv video file', 'techmarket-extensions' ); ?></span>
								</label>
							</th>
							<td>
						...
						<tr>
							<th>
								<label for="postformat_video_webm">
									<strong><?php esc_html_e( 'WEBM File URL', 'techmarket-extensions' ); ?></strong>
									<span><?php esc_html_e( 'The URL to the .webm video file', 'techmarket-extensions' ); ?></span>
								</label>
							</th>
							<td>
						...
						<tr>
							<th>
								<label for="postformat_video_poster">
									<strong><?php esc_html_e( 'Video Poster', 'techmarket-extensions' ); ?></strong>
									<span><?php esc_html_e( 'A preivew image.', 'techmarket-extensions' ); ?></span>
								</label>
							</th>
							<td>
						...
						<tr style="border-top: 1px solid #eeeeee;">
							<th>
								<label for="postformat_video_embed">
									<strong><?php esc_html_e( 'Embedded Code', 'techmarket-extensions' ); ?></strong>
									<span><?php esc_html_e( 'If not using self hosted video you can include embeded code here.', 'techmarket-extensions' ); ?></span>
								</label>
							</th>
							<td>
