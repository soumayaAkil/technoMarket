<div class="cf-elm-block" id="cfpf-format-quote-fields" style="display: none;">
	<div id="postbox-container-postformat" class="postbox-container">
		<div id="meta-box-postformat-video" class="postbox" style="display: block;">
			...
			<h3><span><?php esc_html_e( 'Quote', 'techmarket-extensions' ); ?></span></h3>
						...
						<tr>
							<th>
								<label for="postformat_quote_text">
									<strong><?php esc_html_e( 'Quote', 'techmarket-extensions' ); ?></strong>
									<span><?php esc_html_e( 'The text being quoted.', 'techmarket-extensions' ); ?></span>
								</label>
							</th>
							<td>
						...
						<tr>
							<th>
								<label for="postformat_quote_source">
									<strong><?php esc_html_e( 'Source Name', 'techmarket-extensions' ); ?></strong>
									<span><?php esc_html_e( 'The person being cited.', 'techmarket-extensions' ); ?></span>
								</label>
							</th>
							<td>
