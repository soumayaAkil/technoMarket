...
/**
 * Elementor Products Carousel Tabs with Featured Product Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Techmarket_Elementor_Products_Carousel_Tabs_With_Featured_Product extends Widget_Base {

    /**
     * Get widget name.
     *
     * Retrieve Products Carousel Tabs with Featured Product widget name.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_name() {
        return 'techmarket_products_carousel_tabs_with_featured_product';
    }

    /**
     * Get widget title.
     *
     * Retrieve Products Carousel Tabs with Featured Product widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_title() {
        return esc_html__( 'Products Carousel Tabs with Featured Product', 'techmarket-extensions' );
    }

    /**
     * Get widget icon.
     *
     * Retrieve Products Carousel Tabs with Featured Product widget icon.
     *
     * @since 1.0.0
     * @access public
     *
     ...
     *
     * Retrieve the list of categories the Products Carousel Tabs with Featured Product widget belongs to.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    /**
     * Register Products Carousel Tabs with Featured Product widget controls.
     *
            ...
            [
                ...
                'fields' => [
                    ...
                    [
                        ...
                        'description'   => esc_html__('Enter slug spearate by comma(,) Note: Only works with Product Category Shortcode.', 'techmarket-extensions'),
                        'condition' => [
                            'featured_product_id' => 'product_category',
                        ],
                    ],
                ],
                'default' => [],
    ...
    /**
     * Render Products Carousel Tabs with Featured Product widget output on the frontend.
     *
...
Plugin::instance()->widgets_manager->register_widget_type( new Techmarket_Elementor_Products_Carousel_Tabs_With_Featured_Product );