...
/**
 * Elementor Products Cards Carousel with Gallery Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Techmarket_Elementor_Products_Cards_Carousel_with_Gallery extends Widget_Base {

    /**
     * Get widget name.
     *
     * Retrieve Products Cards Carousel with Gallery widget name.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_name() {
        return 'techmarket_product_card_carousel_with_gallery';
    }

    /**
     * Get widget title.
     *
     * Retrieve Products Cards Carousel with Gallery widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_title() {
        return esc_html__( 'Products Cards Carousel with Gallery', 'techmarket-extensions' );
    }

    /**
     * Get widget icon.
     *
     * Retrieve Products Cards Carousel with Gallery widget icon.
     *
     * @since 1.0.0
     * @access public
     *
     ...
     *
     * Retrieve the list of categories the Products Cards Carousel with Gallery widget belongs to.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    /**
     * Register Products Cards Carousel with Gallery widget controls.
     *
    ...
    /**
     * Render Products Cards Carousel with Gallery widget output on the frontend.
     *
...
Plugin::instance()->widgets_manager->register_widget_type( new Techmarket_Elementor_Products_Cards_Carousel_with_Gallery );