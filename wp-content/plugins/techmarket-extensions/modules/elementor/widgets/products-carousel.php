 ...
 * @since 1.0.0
 */
class Techmarket_Elementor_Products_Carousel extends Widget_Base {
    ...
    public function get_name() {
        return 'techmarket_products_carousel';
    }
    ...
    public function get_title() {
        return esc_html__( 'Products Carousel', 'techmarket-extensions' );
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new Techmarket_Elementor_Products_Carousel );