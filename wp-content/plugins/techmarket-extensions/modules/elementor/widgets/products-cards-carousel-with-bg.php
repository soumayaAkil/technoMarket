...
/**
 * Elementor Products Cards Carousel with Image Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Techmarket_Elementor_Products_Cards_Carousel_with_Image extends Widget_Base {

    /**
     * Get widget name.
     *
     * Retrieve Products Cards Carousel with Image widget name.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_name() {
        return 'techmarket_products_cards_carousel_with_bg';
    }

    /**
     * Get widget title.
     *
     * Retrieve Products Cards Carousel with Image widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_title() {
        return esc_html__( 'Products Cards Carousel with Image', 'techmarket-extensions' );
    }

    /**
     * Get widget icon.
     *
     * Retrieve Products Cards Carousel with Image widget icon.
     *
     * @since 1.0.0
     * @access public
     *
     ...
     *
     * Retrieve the list of categories the Products Cards Carousel with Image widget belongs to.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    /**
     * Register Products Cards Carousel with Image widget controls.
     *
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'rows' => 2,
                'default' => '<strong>Power Audio &amp; Visual </strong>entertainment',
    ...
    /**
     * Render Products Cards Carousel with Image widget output on the frontend.
     *
...
Plugin::instance()->widgets_manager->register_widget_type( new Techmarket_Elementor_Products_Cards_Carousel_with_Image );