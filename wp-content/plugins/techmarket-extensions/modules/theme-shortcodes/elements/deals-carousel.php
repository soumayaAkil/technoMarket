...
if ( ! function_exists( 'techmarket_deals_carousel_element' ) ) {

	function techmarket_deals_carousel_element( $atts, $content = null ){
...
add_shortcode( 'techmarket_deals_carousel' , 'techmarket_deals_carousel_element' );