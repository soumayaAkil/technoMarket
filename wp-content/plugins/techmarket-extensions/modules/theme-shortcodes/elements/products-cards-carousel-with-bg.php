...
if ( ! function_exists( 'techmarket_products_cards_carousel_with_bg_element' ) ) {

	function techmarket_products_cards_carousel_with_bg_element( $atts, $content = null ){
		...
		$args = array(
			...
			'bg_image'			=> isset( $image ) && intval( $image ) ? wp_get_attachment_image_src( $image, 'full' ) : '',
			'carousel_args'		=> array(
...
add_shortcode( 'techmarket_products_cards_carousel_with_bg' , 'techmarket_products_cards_carousel_with_bg_element' );