...
if ( ! function_exists( 'techmarket_products_carousel_with_bg_element' ) ) {

	function techmarket_products_carousel_with_bg_element( $atts, $content = null ){
...
add_shortcode( 'techmarket_products_carousel_with_bg' , 'techmarket_products_carousel_with_bg_element' );