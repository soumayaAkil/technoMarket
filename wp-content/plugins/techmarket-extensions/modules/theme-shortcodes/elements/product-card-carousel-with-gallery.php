...
if ( ! function_exists( 'techmarket_product_card_carousel_with_gallery_element' ) ) {

	function techmarket_product_card_carousel_with_gallery_element( $atts, $content = null ){
...
add_shortcode( 'techmarket_product_card_carousel_with_gallery' , 'techmarket_product_card_carousel_with_gallery_element' );