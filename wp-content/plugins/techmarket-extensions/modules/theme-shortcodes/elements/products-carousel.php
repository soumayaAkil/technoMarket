...
if ( ! function_exists( 'techmarket_products_carousel_element' ) ) {

	function techmarket_products_carousel_element( $atts, $content = null ){
...
add_shortcode( 'techmarket_products_carousel' , 'techmarket_products_carousel_element' );